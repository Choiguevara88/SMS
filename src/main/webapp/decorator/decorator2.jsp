...
예를 들어 서비스를 방해하거나 '쉐어 마이 스페이스'이 제공하는 인터페이스 및 안내사항 이외의 다른 방법을 사용하여 액세스를 시도하지 않아야 합니다. 
귀하는 관련 수출 및 재수출 통제 법규 및 규정 등 오직 법률상 허용되는 범위에서만 '쉐어 마이 스페이스' 서비스를 이용할 수 있습니다. 
귀하가 '쉐어 마이 스페이스' 약관이나 정책을 준수하지 않거나 '쉐어 마이 스페이스'이 부정행위 혐의를 조사하고 있는 경우, '쉐어 마이 스페이스' 서비스 제공이 일시 중지 또는 중단될 수 있습니다.</p>

<p>'쉐어 마이 스페이스' 서비스를 사용한다고 해서 '쉐어 마이 스페이스' 서비스 또는 액세스하는 콘텐츠의 지적재산권을 소유하게 되는 것은 아닙니다. 
콘텐츠 소유자로부터 허가를 받거나 달리 법률에 따라 허용되는 경우를 제외하고, '쉐어 마이 스페이스' 서비스의 콘텐츠를 사용할 수 없습니다. 
본 약관은 귀하에게 '쉐어 마이 스페이스' 서비스에 사용된 브랜드나 로고를 사용할 권리를 부여하지 않습니다. 
'쉐어 마이 스페이스' 서비스에 또는 '쉐어 마이 스페이스' 서비스와 함께 게재된 어떠한 법적 고지도 삭제하거나 감추거나 변경하지 마십시오.</p>

<p>'쉐어 마이 스페이스' 서비스는 '쉐어 마이 스페이스'이 소유하지 않은 일부 콘텐츠를 표시할 수 있습니다. 
그러한 콘텐츠에 대해서는 제공한 주체가 단독으로 책임지게 됩니다. 
'쉐어 마이 스페이스'는 콘텐츠의 위법성 여부 또는 '쉐어 마이 스페이스' 정책 위반 여부를 결정하기 위해 검토할 수 있으며, 콘텐츠가 '쉐어 마이 스페이스' 정책 또는 법률에 위반된다고 합리적으로 판단하는 경우 이를 삭제하거나 게시를 거부할 수 있습니다.
 그렇다고 반드시 콘텐츠를 검토한다는 의미는 아니므로, 콘텐츠를 검토할 것이라고 간주하지 마십시오.</p>

<p>서비스 이용과 관련하여 '쉐어 마이 스페이스'는 귀하에게 서비스 고지, 관리 메시지 및 기타 정보를 발송할 수 있습니다. 귀하는 메시지 수신을 거부할 수 있습니다.</p>

<p>일부 '쉐어 마이 스페이스' 서비스는 휴대기기에서 사용할 수 있습니다. 트래픽 또는 보안 관련 법규 준수를 방해하거나 막는 방식으로 서비스를 사용해서는 안 됩니다.</p>

<p><h5><strong>귀하의 '쉐어 마이 스페이스' 계정</strong></h5></p>
...
<p><h5><strong>개인정보 보호 및 저작권 보호</strong></h5></p>
...
<p><h5><strong>'쉐어 마이 스페이스' 서비스에 포함된 귀하의 콘텐츠</strong></h5></p>
...
<p><h5><strong>'쉐어 마이 스페이스' 서비스에 포함된 소프트웨어에 대하여</strong></h5></p>
...
<p><h5><strong>'쉐어 마이 스페이스' 서비스의 수정 및 해지</strong></h5></p>
...
<p><h5><strong>'쉐어 마이 스페이스'의 보증 및 부인</strong></h5></p>
...
<p><h5><strong>'쉐어 마이 스페이스' 서비스에 대한 책임</strong></h5></p>
...
<p><h5><strong>업체의 '쉐어 마이 스페이스' 서비스 사용</strong></h5></p>
...
<p><h5><strong>본 약관에 대하여</strong></h5></p>
