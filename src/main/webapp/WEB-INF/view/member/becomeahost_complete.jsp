...
<br>
 ...
 <div>
 	...
 	<div>
 		...
 		<input class="w3-button w3-xlarge w3-purple" type="button" align="right" onclick="document.getElementById('id014').style.display='block'" value="이용약관보기">
...
<p>법률상 허용되는 한도 내에서, 묵시적 보증을 포함하여 본 약관에 따른 청구에 대한 '쉐어 마이 스페이스', '쉐어 마이 스페이스'의 공급자 및 판매자의 총 책임은 귀하가 서비스 사용을 위해 '쉐어 마이 스페이스'에 지급한 금원(또는 '쉐어 마이 스페이스'의 선택에 따라 귀하에게 서비스를 다시 제공하는 것)으로 제한됩니다.</p>
...
서비스 이용 또는 해당 약관 위반으로 인해 발생하거나 이와 관련된 모든 소송, 고소 또는 조치로부터 '쉐어 마이 스페이스'과 '쉐어 마이 스페이스'의 제휴사, 임원, 대행사 및 직원을 보호하고 면책해야 하며 여기에는 각종 책임과 소송, 손실, 피해, 고소, 판결, 소송 비용 및 변호사 수임료 등으로 인한 비용도 포함됩니다.</p>
...
본 약관 또는 서비스와 관련하여 발생하는 분쟁에 대해서는 미국 캘리포니아주 법률이 적용되며, 캘리포니아 주 국제사법의 적용은 배제됩니다. 본 약관 또는 서비스와 관련하여 발생되는 모든 소송은 독점적으로 미국 캘리포니아주 산타클라라 카운티의 연방 또는 주 법원에서 다루어지며 귀하와 '쉐어 마이 스페이스'는 이러한 법원이 인적 관할을 갖는 것에 동의합니다.</p>
      </div>
    </div>
  </div>
</body>
