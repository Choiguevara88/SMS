...
<c:forEach var="board" items="${boardlist}">
	...
	<tr>
  		...
  		<a href="../qa/reply.sms?bNo=${board.bNo}&pageNum=${pageNum}">[답변]</a>
		<a href="../qa/update.sms?bNo=${board.bNo}&pageNum=${pageNum}">[수정]</a>
		<a href="../qa/delete.sms?bNo=${board.bNo}&pageNum=${pageNum}">[삭제]</a><br>
 	 </td>
</tr>
<!--  글 밑 부분 -->
</c:forEach>
